      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
        <label className="flex items-start cursor-pointer">
          ...
          <span className="ml-3 text-sm text-gray-700">
            I understand that Nostr for Nomads is a decentralized platform built on Nostr. I am responsible for managing my own keys and there is no password recovery. I have safely stored my backup file and understand that losing my keys means losing access to this account permanently.
          </span>
        </label>
      </div>
